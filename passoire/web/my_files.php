		...
		<div class="w3-col m12">
			...
			<div class="w3-card w3-round w3-white">
				<div class="w3-container w3-center center-c">
					...
					<a href="file_upload.php" class="w3-button w3-theme w3-padding" title="Files"><i
							class="fa fa-folder-open"></i>Upload File(s)</a>
				</div>
				<br>
						...
						<table class="w3-table">
							...
							<?php foreach ($files as $file): ?>
								<tr>
									...
									<td>
										<!-- Copy Link Button -->
										<button class="w3-button w3-theme w3-padding"
											onclick="copyLink('<?= $file['hash'] ?>')">Copy Link</button>
